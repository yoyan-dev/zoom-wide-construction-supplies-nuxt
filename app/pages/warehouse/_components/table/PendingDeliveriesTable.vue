...
import PendingDeliveryRowActions from "./PendingDeliveryRowActions.vue";
...
const columns: TableColumn<Delivery>[] = [
  ...
  { id: "scheduled", header: "Scheduled", accessorFn: (row) => row.scheduled_at ?? "" },
  { id: "actions", header: "" },
];
  ...
  <UCard>
    <div class="mb-4 flex items-center justify-between">
      <div>
        ...
        <p class="mt-1 text-lg font-semibold">Outbound schedule</p>
      </div>
    ...
    >
      ...
      <template #actions-cell="{ row }">
        <div class="flex justify-end">
          <PendingDeliveryRowActions :delivery="row.original" />
        </div>
      </template>
    </UTable>
